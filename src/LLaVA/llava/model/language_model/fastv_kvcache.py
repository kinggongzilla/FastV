...
class FastVQwen2Model(Qwen2Model):
    ...
    def __init__(self, config: Qwen2Config):
        config._attn_implementation = "sdpa"  # Use Qwen2SqpaAttention instead of Qwen2FlashAttention2
        config._attn_implementation_internal = "sdpa"  # Use Qwen2SqpaAttention instead of Qwen2FlashAttention2
        self.last_attention = None
        super().__init__(config)
        ...
        for decoder_layer in self.layers:
            ...
            if self.gradient_checkpointing and self.training:
                ...
                if decoder_layer.self_attn.layer_idx == K and seq_length > 1:
                    ...
                    #make position_ids a range from 0 to length of position_ids
